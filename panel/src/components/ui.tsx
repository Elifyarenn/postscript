...
export const STATUS_LABELS: Record<string, string> = {
  ...
  category_approved: "Kategori onayı geçti",
  admin_review: "Yönetici kuyruğunda",
...
const BADGE_TONES: Record<string, string> = {
  ...
  category_approved: "bg-accent-soft text-accent border-accent/30",
  ...
  admin_review: "bg-warning-soft text-warning border-warning/30",
